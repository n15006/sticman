...
def collided_right(co1, co2):
    return (within_y(co1, co2)
            and co2.x1 <= co1.x2 <= co2.x2)

def collided_top(co1, co2):
    return (within_x(co1, co2)
           and co2.y1 <= co1.y1 <=co2.y2)

def collided_bottom(y, co1, co2):
    return (within_x(co1, co2)
            and co2.y1 <= co1.y2 + y <= co2.y2)
...
if __name__ == '__main__':
    ...
    platform5 = PlatformSprite(g, PhotoImage(file="stickman/platform2.gif"), 160, 350, 100, 10)
    platform6 = PlatformSprite(g, PhotoImage(file="stickman/platform2.gif"), 50, 300, 100, 10)
    platform7 = PlatformSprite(g, PhotoImage(file="stickman/platform2.gif"), 190, 90, 100, 10)
    platform8 = PlatformSprite(g, PhotoImage(file="stickman/platform2.gif"), 45, 60, 100, 10)
    platform9 = PlatformSprite(g, PhotoImage(file="stickman/platform3.gif"), 170, 250, 100, 10)
    platform10 = PlatformSprite(g, PhotoImage(file="stickman/platform3.gif"), 260, 200, 100, 10)
